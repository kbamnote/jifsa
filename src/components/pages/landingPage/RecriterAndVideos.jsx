...
const RecruiterAndVideos = () => {
  return (
    <div className="bg-gray-100 py-12 px-6 max-w-8xl mx-auto">
      {/* Recruiter Companies */}
      <div className="mb-16">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="border border-blue-500 text-blue-600 px-4 py-1 rounded-md hover:bg-blue-50 transition">
            View All
          </button>
        </div>
