...
const courses = [
  {
    code: "BVOC_ADFS",
    name: "ADVANCE DIPLOMA IN FIRE AND SAFETY (Industrial and Construction)",
    duration: "2 YEARS",
    module: 4,
  },
  {
    code: "BVOC_Bfs_FS",
    name: "BATCHLOR IN FIRE AND SAFETY (Industrial and Construction)",
    duration: "3 YEARS",
    module: 6,
  },
  {
    code: "BVOC_DFS",
    name: "DIPLOMA IN FIRE AND SAFETY (Industrial and Construction)",
    duration: "1 Year",
    module: 2,
  },
  {
    ...
    <section className="w-full py-12 px-4 md:px-12">
      ...
      <div className="text-center mb-6">
        <h2 className="text-2xl md:text-3xl font-semibold text-blue-900">
          University, NCVET Industrial Safety Courses
        </h2>
...
export default SafetyCoursesTable;
